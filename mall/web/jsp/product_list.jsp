...
<div class="row" style="width:1210px;margin:0 auto;">
    ...
    <c:if test="${not empty page.records}">
        <c:forEach var="item" items="${page.records}">
            ...
            <div class="col-md-2">
                <a href="${pageContext.request.contextPath}/productServlet?method=findProductByPid&pid=${item.pid}">
                    <img src="${pageContext.request.contextPath}/${item.pimage}" width="170" height="170"
                         style="display: inline-block;">
                </a>
                <p><a href="${pageContext.request.contextPath}/jsp/product_info.jsp" style='color:green'>${item.pname}</a></p>
