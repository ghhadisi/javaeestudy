...
<div class="container">
    <form method="post" action="${pageContext.request.contextPath}/cartServlet?method=addToCart" id="form1">
        <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div style="padding:10px;border:1px solid #e7dbb1;width:330px;margin:15px 0 10px 0;;background-color: #fffee6;">
                        ...
                        <div style="border-bottom: 1px solid #faeac7;margin-top:20px;padding-left: 10px;">购买数量:
                            <input id="quantity" name="number" value="1" maxlength="4" size="10" type="text">

                            <input type="hidden" name="pid" value="${product.pid}">
                            <input type="hidden" name="ranStr" value="${ranStr}">
